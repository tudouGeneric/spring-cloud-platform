...
CREATE TABLE IF NOT EXISTS `rbac_user` (
  ...
  `enable` tinyint(0) NOT NULL DEFAULT 1 COMMENT '是否启用(0:禁用; 1:启用)',
...
-- 初始化用户和角色
-- --------------------------------
INSERT INTO `rbac_user`(`id`, `age`, `name`, `sex`, `birth`, `account`, `password`, `department_id`, `nick_name`, `email`, `mobile_phone`, `photo_url`, `last_password_reset_date`, `enable`, `delete_status`, `created_by`, `created_time`, `updated_by`, `updated_time`, `version`) VALUES (1, 0, '管理员', 'X', '2020-10-26 00:00:00', 'admin', '$2a$10$skro.LrrPfjbtoyQjsthgus/7WiTkQITJIzUMAi8MhDlnCUNgKS3G', 1, '管理员', NULL, NULL, NULL, NOW(), 1, 0, NULL, NULL, NULL, NULL, 0);
